...
public class SachTraAdapter extends ArrayAdapter<Sach> {
    ...
    public SachTraAdapter(Context context, int resource, List<Sach> objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.edsoluong.setText(String.valueOf(Sach.getSoLuong()));
...
//        }
        viewHolder.btntang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sachmuons.get(position).setSoluong(Sach.getSoLuong()-sl);
            }
        });
    ...
    public void TangSL(EditText edit,int max)
    {
        ...
        if(sl<max) {
            ...
            Toast.makeText(context,"Trả hết sách rồi",Toast.LENGTH_SHORT).show();
        }
